...
console.log('\n⚖️  Legal Notice:');
console.log('   This is the legal notice as it was displayed on the repository that I have');
console.log('   forked (https://github.com/thrynae/BibleDownloader). If you think something is');
console.log('   wrong or inaccurate, let me know and I\'ll take action accordingly.');
console.log('   I am no legal expert.');
